...
namespace Cheng.Comon
{
    public class RedisCacheService : ICacheService
    {
        ...
        public RedisCacheService(CSRedisClient cache)
        {

            _cache = new CSRedis.CSRedisClient(MarketConfigModel.RedisConfiguration);
            RedisHelper.Initialization(_cache);
        }

        public static CSRedisClient Default { get; private set; }
        static RedisCacheService()
        {
            Default = new CSRedis.CSRedisClient(MarketConfigModel.RedisConfiguration);
        }
